...
use commap,          only: clat, clon ! added from CESM2.2
...
subroutine read_inidat()
   ...
   !fh_topo => topo_file_get_id() ! moved to set_phis (from CESM2.2)
   ...
   if (analytic_ic_active()) then
      ...
      ! moved to set_phis (from CESM2.2)
